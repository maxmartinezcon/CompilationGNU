...
# 47 "system_msp432p401r.c" 2
# 90 "system_msp432p401r.c"
uint32_t SystemCoreClock = 3000000;
# 101 "system_msp432p401r.c"
void SystemCoreClockUpdate(void)
{
    ...
    divider = (((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL1 & ((uint32_t)0x00070000)) >> (16);
    dividerValue = 1 << divider;
    source = ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL1 & ((uint32_t)0x00000007);

    switch(source)
    {
    case ((uint32_t)0x00000000):
        if((*((volatile uint8_t *) (((uint32_t)(0x42000000)) + (((uint32_t)(uint32_t *)&((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->IFG) - ((uint32_t)0x40000000))*32 + ( 0)*4))))
        {

            ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->KEY = ((uint32_t)0x0000695A);
            ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CLRIFG |= ((uint32_t)0x00000001);
            ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->KEY = 1;

            if((*((volatile uint8_t *) (((uint32_t)(0x42000000)) + (((uint32_t)(uint32_t *)&((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->IFG) - ((uint32_t)0x40000000))*32 + ( 0)*4))))
            {
                if((*((volatile uint8_t *) (((uint32_t)(0x42000000)) + (((uint32_t)(uint32_t *)&((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CLKEN) - ((uint32_t)0x40000000))*32 + (15)*4))))
                {
            ...
            {
                SystemCoreClock = 32768 / dividerValue;
            }
        }
        else
        {
    ...
    case ((uint32_t)0x00000001):
        SystemCoreClock = 10000 / dividerValue;
        break;
    ...
    case ((uint32_t)0x00000003):
        dcoTune = (((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL0 & ((uint32_t)0x000003FF)) >> ( 0);

        switch(((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL0 & ((uint32_t)0x00070000))
        {
        case ((uint32_t)0x00000000):
        ...
        else
        {
            ...
            if ((*((volatile uint8_t *) (((uint32_t)(0x42000000)) + (((uint32_t)(uint32_t *)&((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL0) - ((uint32_t)0x40000000))*32 + (22)*4))))
            {
                dcoConst = *((float *) &((TLV_Type *) ((uint32_t)0x00201000))->DCOER_CONSTK_RSEL04);
                calVal = ((TLV_Type *) ((uint32_t)0x00201000))->DCOER_FCAL_RSEL04;
            }

            else
            {
                dcoConst = *((float *) &((TLV_Type *) ((uint32_t)0x00201000))->DCOIR_CONSTK_RSEL04);
                calVal = ((TLV_Type *) ((uint32_t)0x00201000))->DCOIR_FCAL_RSEL04;
            }
    ...
    case ((uint32_t)0x00000004):
        SystemCoreClock = 24000000 / dividerValue;
        break;
    case ((uint32_t)0x00000005):
        if((*((volatile uint8_t *) (((uint32_t)(0x42000000)) + (((uint32_t)(uint32_t *)&((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->IFG) - ((uint32_t)0x40000000))*32 + ( 1)*4))))
        {

            ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->KEY = ((uint32_t)0x0000695A);
            ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CLRIFG |= ((uint32_t)0x00000002);
            ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->KEY = 1;
            ...
            {
                SystemCoreClock = 48000000 / dividerValue;
            }
        }
        else
        {
...
void SystemInit(void)
{
    ...
    ((WDT_A_Type *) (((uint32_t)0x40000000) +0x00004800))->CTL = ((uint16_t)0x5A00) | ((uint16_t)0x0080);


    ((SYSCTL_Type *) (((uint32_t)0xE0000000)+0x00043000))->SRAM_BANKEN = ((uint32_t)0x00000080);
# 316 "system_msp432p401r.c"
    ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->KEY = ((uint32_t)0x0000695A);
    ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL0 = ((uint32_t)0x00010000);
    ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL1 = (((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->CTL1 & ~(((uint32_t)0x00000007) | ((uint32_t)0x00070000))) | ((uint32_t)0x00000003);

    ((CS_Type *) (((uint32_t)0x40000000) +0x00010400))->KEY = 0;


    ((FLCTL_Type *) (((uint32_t)0x40000000) +0x00011000))->BANK0_RDCTL = ((FLCTL_Type *) (((uint32_t)0x40000000) +0x00011000))->BANK0_RDCTL & ~(((uint32_t)0x00000020) | ((uint32_t)0x00000010));
    ((FLCTL_Type *) (((uint32_t)0x40000000) +0x00011000))->BANK1_RDCTL = ((FLCTL_Type *) (((uint32_t)0x40000000) +0x00011000))->BANK1_RDCTL & ~(((uint32_t)0x00000020) | ((uint32_t)0x00000010));
# 403 "system_msp432p401r.c"
}
